...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-32 bg-slate-950 text-white">
      <div className="container mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-yellow-600 clean-border rounded-3xl overflow-hidden elevated-shadow">
            {/* Widget Header */}
            <div className="bg-yellow-600 px-8 py-6 border-b border-border">
            ...
            <div className="p-0 bg-yellow-600">
              <div 
                style={{
                  width: '100%',
                  height: '600px',
